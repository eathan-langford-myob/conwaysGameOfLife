...
public class RulesTest {
    ...
    public void shouldReturnNumberOfLiveNeighbors_WhenQueryingRules() {
        ...
        long actual = CellLifeRulesCalculator.getNumberOfLiveCellsFromNeighbors(neighbors);
        long expected = 3;
    ...
    public void shouldReturnLiveCell_WhenSurroundedBy3LiveCells() {
        ...
        boolean actual = CellLifeRulesCalculator.calculateCellLifeExpectancy(queriedCell, neighbors);
    ...
    public void shouldReturnArrayOfNextGenerationCoordinates_WhenGridHas3LiveCells_PropellerPattern() {
        ...
        ArrayList<Coordinate> actual = CellLifeRulesCalculator.getCoordinatesOfNextGenerationsCells(grid);
